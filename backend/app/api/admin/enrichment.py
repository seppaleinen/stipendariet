...
class EnrichmentTestRequest(BaseModel):
    ...
    validation_sys_prompt: Optional[str] = None
    validation_usr_prompt: Optional[str] = None
    extraction_sys_prompt: Optional[str] = None
    extraction_usr_prompt: Optional[str] = None
